...
<%
    ...
    if (request.getParameter("userName") != null) //get "uname" jQuery & Ajax part this line 'data:"uname="+username' from index.jsp file check not null
    {
        String user_name = request.getParameter("userName"); //getable "uname" store in new "user_name variable"
