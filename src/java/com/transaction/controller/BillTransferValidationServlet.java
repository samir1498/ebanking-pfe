 ...
 * @author Samir
 */
@WebServlet(name = "AccountTransferValidationServlet", urlPatterns = {"/BillTransferValidation"})
public class BillTransferValidationServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    String data = request.getParameter("BillerAccount");
